    ...
    return (
      <div className="zv-layout">
        <div className="zv-box">
          ...
          <label className="zv-butt">

            <input type="checkbox" className="sliderCheck" />

            <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="160 10 180 140">
              <defs>
                <style
                  dangerouslySetInnerHTML={{__html: ".cls-1{fill:none;}.cls-2{clip-path:url(#clip-path);}.cls-3{fill:#be3434;}.cls-4{fill:#00c200;}.cls-5{opacity:0.25;}.cls-6{opacity:0.15;}.cls-7{fill:#dcdcdc;}.cls-8{clip-path:url(#clip-path-3);}.cls-9{fill:#ababab;}.cls-10{fill:#f2f2f2;}.cls-11{fill:#d1d1d1;}.cls-12{fill:#dedede;}.cls-13{fill:#fff;}.cls-14{fill:#e1e1e1;}.cls-15{clip-path:url(#clip-path-4);}"}}/>
              ...
              <g id="Layer_2" data-name="Layer 2">
                <g id="Layer_4" data-name="Layer 4">
                  <g id="bg">
                    <g className="cls-2">
                      <g id="sliderBG">
                        <rect className="cls-3" x={166} y={41} width={166} height={72}/>
                        <rect className="cls-4" y={41} width={166} height={72}/>
                      </g>
                    </g>
                  </g>
                  <polygon id="bgshadow" className="cls-5"
                  ...
                  <g id="side">
                    <polygon className="cls-7"
                             points="267 59 265 59 265 63 261 63 261 67 257 67 257 70 254 70 254 72 251 72 251 73 247 73 247 75.1 245 75.1 245 76.09 242 76.09 242 77.08 238 77.08 238 79.05 226 79.05 226 80 212 80 212 79.05 200 79.05 200 77.08 196 77.08 196 76.09 193 76.09 193 75.1 191 75.1 191 73 187 73 187 72 184 72 184 70 181 70 181 67 177 67 177 63 173 63 173 59 171 59 171 54.5 169 54.5 169 84 171 84 171 88 173 88 173 92 177 92 177 96 182 96 182 97 184 97 184 101 187 101 187 103 191 103 191 105 193 105 193 106 196 106 196 107 200 107 200 108 203 108 203 109 212 109 212 110 226 110 226 109 235 109 235 108 238 108 238 107 242 107 242 106 245 106 245 105 247 105 247 103 251 103 251 101 254 101 254 97 256 97 256 96 261 96 261 92 265 92 265 88 267 88 267 84 269 84 269 54.5 267 54.5 267 59"/>
                    <g className="cls-8">
                      <rect className="cls-9" x={169} y={50} width={5} height={47}/>
                      <rect className="cls-9" x={188} y={63} width={9} height={47}/>
                      <rect className="cls-10" x={199} y={67} width={7} height={47}/>
                      <rect className="cls-11" x={226} y={70} width={9} height={47}/>
                      <rect className="cls-11" x={238} y={70} width={5} height={47}/>
                      <rect className="cls-11" x={255} y={61} width={6} height={47}/>
                      <rect className="cls-10" x={264} y={51} width={5} height={47}/>
                      <rect className="cls-11" x={174} y={50} width={9} height={56}/>
                      <rect className="cls-10" x={183} y={63} width={3} height={47}/>
                      <rect className="cls-10" x={242} y={72} width={6} height={34}/>
                      <rect className="cls-9" x={251} y={69} width={4} height={34}/>
                      <rect className="cls-9" x={261} y={58} width={4} height={34}/>
                    </g>
                  </g>
                  <g id="cap">
                    <rect className="cls-12" x={179} y="28.66" width={80} height="40.34"/>
                    <rect className="cls-12" x={182} y="28.66" width={74} height="42.34"/>
                    <rect className="cls-12" x={183} y="28.66" width={72} height="44.34"/>
                    <rect className="cls-13" x="200.29" y="18.96" width="35.43" height="62.06"/>
                    <rect className="cls-12" x={186} y="28.66" width={66} height="46.19"/>
                    <rect className="cls-12" x="193.54" y="28.66" width="50.93" height="49.54"/>
                    <rect className="cls-12" x="197.96" y="26.82" width="42.07" height="51.22"/>
                    <rect className="cls-12" x="190.21" y="28.66" width="57.57" height="47.86"/>
                    <rect className="cls-13" x="210.25" y="18.97" width="15.5" height="64.03"/>
                    <rect className="cls-13" x={216} y="18.97" width={6} height="64.03"/>
          ...
          <div className="zv-box _inner">
            ...
            <div className="zv-line">
              ...
              <div className="zv-calc">
                ...
                <label>
                  ...
                  <div/>
                  {this.state.arrange ? 'Нужна' : 'Не нужна'}
                </label>
              </div>
            ...
            <div className="zv-line">
              <div className="zv-calc">
                <label>Общая</label>
                <div>{this.state.price}<span>₴</span></div>
              </div>
              <div className="zv-calc">
              </div>
              <div className="zv-calc">
